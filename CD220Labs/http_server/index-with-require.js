...
const requestListener = function (req, res) {
    ...
    //Tunnig the greeting according to the current time
    ...
    // Befote implementation of greeting: Send the response with the current date from the 'today' module
    //Befote implementation of greeting: res.end(`Hello, World! The date today is ${today.getDate()}`);
};
